<?php
    ...
    $latest_task=strtotime($all_task[0]['task_created_at']);
    ...
    $latest_project=strtotime($all_project[0]['project_created_at']);


    $all_meeting=get_meeting($_SESSION['user_info']['member_id'],'1');
    $count_meeting=isset($all_meeting)?count($all_meeting):'0';
    $latest_meeting=strtotime($all_meeting[0]['meeting_created_at']);
