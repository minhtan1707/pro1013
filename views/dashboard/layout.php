        ...
        <div class="topbar">
            ...
            <div class="topbar-left">
                <a href="index.html" class="logo">
                    ...
                    <i>
                        <img src="./static/images/logo_sm.png" alt="" height="28">
                    </i>
                </a>
            </div>
            ...
            <div class="slimscroll-menu" id="remove-scroll">
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu" id="side-menu">
                        ...
                        <li>
                            <a href="javascript: void(0);"><i class="fi-disc"></i><span class="badge badge-warning pull-right">12</span>
                                <span> Forms </span></a>
                            <ul class="nav-second-level" aria-expanded="false">
                        ...
                        <li class="has_sub">
                            <a href="javascript:void(0);"><i class="fi-marquee-plus"></i><span> Extra Pages </span>
