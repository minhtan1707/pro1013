...
<body>
					...
					<nav class="navbar navbar-custom">
						<div class="container-fluid">
							<div class="navbar-header">
								...
								<a class="navbar-brand" href="#"><img src="./static/images/logo.png" alt="logo" height="30"></a>
							</div>
						...
						<div id="tour" class="carousel slide" data-ride="carousel">
							...
							<div class="carousel-inner">
								...
								<div class="item active">
									<img src="./static/home/images/stock1.png" alt="slide-img">
								</div>
							</div>
		...
		<div class="container text-center">
			...
			<div class="row">
				<div class="col-sm-12">
					...
					<p class="slogan">Các tiện ích nổi bật của Project Managerment xoay quanh các tính năng hỗ trợ teamwork và quan
						trọng nhất chính là Real Time.</p>
				</div>
			</div> <!-- End row -->
			...
			<div class="row p-t-50">
				<div class="col-sm-4">
					...
					<div>
						<h4>Tạo Dự Án</h4>
						<p>Các tài khoản của Project Managerment có thể tạo một hoặc cách dự án và thêm các thành viên khác vào dự án của
							mình.</p>
					</div>
				</div> <!-- end col -->
				...
				<div class="col-sm-4">
					...
					<div>
						<h4>Quản Lí Dự Án</h4>
						<p>Các tài khoản tạo dự án (Leader) có thể quản lí dự án của mình (thời gian deadline dự án, công việc; quản lí
							các thành viên trong dự án,...)</p>
					</div>
				</div> <!-- end col -->
				...
				<div class="col-sm-4">
					...
					<div>
						...
						<p>Leader có thể tạo các buổi họp có thời gian đia điểm rõ ràng cho từng buổi họp và các buổi họp đều có nội dung
							cụ thể.</p>
					</div>
				</div> <!-- end col -->
			...
			<div class="row">
				<div class="col-sm-4">
					...
					<div>
						...
						<p>Các thành viên trong dự án có thể tương tác với nhau qua tính năng comment ở trong từng tác vụ (công việc được
							giao), cũng như là tương tác với nhau qua box chat dự án.</p>
					</div>
				</div> <!-- end col -->
				...
				<div class="col-sm-4">
					...
					<div>
						...
						<p>Leader có thể tạo và giao các công việc cho các thành viên trong nhóm (có thời gian dealine, nội dung công
							việc cụ thể ).</p>
					</div>
				</div> <!-- end col -->
				...
				<div class="col-sm-4">
					...
					<div>
						...
						<p>Leader có thể quản lí được thời gian kết thúc của dự án (có thể chỉnh sửa thời gian kết thúc, hoặc xóa thời
							gian kết thúc "dự án dài hạn" ).</p>
					</div>
				</div> <!-- end col -->
			...
			<div class="row">
				...
				<div class="col-sm-6">
					<div class="feature-sec">
						...
						<p>Project Managerment có giao diện đơn giản và dễ dàng sử dụng, mọi người đều có thể dễ dàng tiếp cận và sử
							dụng. Giao diện của Project Managerment màu sắc đơn giản không quá màu mè, các nút tính năng nằm gọn một nơi nên
							người sử dụng không tốn quá nhiều thời gian để tìm kiếm.</p>
						<a href="#" class="btn-custom btn w-md">Bắt Đầu</a>
					</div>
				</div><!-- end col -->
	...
	<section class="section pb0" id="pricing">
		<div class="container">

			<div class="row text-center">
				<div class="col-sm-12">
					<h2 class="title">Các Gói Sản Phẩm Hiện Tại</h2>
					<p class="slogan">Hiện tại Project Managerment các bạn có thể sử dụng miễn phí, hoặc các bạn có thể mua các gói
						nâng cao để có thể sử dụng các tính năng tiện ích hơn, ưa việt hơn để tăng hiệu quả làm việc dự án.</p>
				</div>
			</div>
				...
				<div class="col-md-10 col-md-offset-1">
					<div class="row p-t-50">
						...
						<article class="pricing-column col-md-4">
							<div class="inner-box card-box">
								<div class="plan-header text-center">
									<h3 class="plan-title">Cá Nhân</h3>
									<h2 class="plan-price">$19</h2>
									<div class="plan-duration">Dành cho các đối tượng như học sinh, sinh viên.</div>
								</div>
								<ul class="plan-stats list-unstyled text-center">
									<li><b>10 </b> Dự án / 1 lần tạo</li>
									<li><b>200 </b> Thành viên / 1 dự án</li>
									<li><b>Không </b> Tạo lịch các buổi họp</li>
									<li><b>5</b> Chức vụ / 1 dự án</li>
									<li><b>Email</b> 200 tài khoản / 1 dự án</li>
									<li><b>Hộp Thoại</b> Không</li>
								</ul>
							</div>
						</article>
						...
						<article class="pricing-column col-md-4">
							<div class="inner-box card-box">
								<div class="plan-header text-center">
									<h3 class="plan-title">Doanh nghiệp</h3>
									<h2 class="plan-price">$29</h2>
									<div class="plan-duration">Dành cho các đối tượng doanh nghiệp vừa và nhỏ.</div>
								</div>
								<ul class="plan-stats list-unstyled text-center">
									<li><b>50 </b> Dự án / 1 lần tạo</li>
									<li><b>900 </b> Thành viên / 1 dự án</li>
									<li><b>Có</b> Tạo lịch các buổi họp</li>
									<li><b>20</b> Chức vụ / 1 dự án</li>
									<li><b>Email</b> 900 tài khoản / 1 dự án</li>
									<li><b>Hộp Thoại</b> Có</li>
								</ul>
							</div>
						</article>
						...
						<article class="pricing-column col-md-4">
							<div class="inner-box card-box">
								<div class="plan-header text-center">
									<h3 class="plan-title">Tập Đoàn</h3>
									<h2 class="plan-price">$39</h2>
									<div class="plan-duration">Dành cho các đối tượng doanh nghiệp lớn, tập đoàn.</div>
								</div>
								<ul class="plan-stats list-unstyled text-center">
									<li><b>100 </b> Dự án / 1 lần tạo</li>
									<li><b>Unlimited </b> Thành viên / 1 dự án</li>
									<li><b>Có</b> Tạo lịch các buổi họp</li>
									<li><b>Unlimited</b> Chức vụ / 1 dự án</li>
									<li><b>Email</b> Không giớn hạn</li>
									<li><b>Hộp Thoại</b> Có</li>
								</ul>
							</div>
						</article>
		...
		<div class="container">
			...
			<div class="row text-center">
				<div class="col-sm-12">
					...
					<p class="slogan">Chúng tôi đã cho tiến hành phỏng vấn các chuyên gia trong lĩnh vực này về trải nghiệm Website
						Ứng Dụng <b>"Cú To"</b>. Đây là những gì họ nói.</p>
				</div>
			</div>
			...
			<div class="row text-center">
				<div class="col-sm-12">
					...
					<ul class="list-inline client-list pt40">
						...
						<li><a href="" title="Instagram"><img src="./static/home/images/clients/instagram.png" alt="clients"></a></li>
						<li><a href="" title="Converse"><img src="./static/home/images/clients/converse.png" alt="clients"></a></li>
					</ul>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-3 col-md-3">
					<a class="navbar-brand-footer" href="#"><img src="./static/images/logo.png" alt="logo" height="28"></a>
				</div>
				<div class="col-lg-4 col-lg-offset-3 col-md-7">
					<ul class="nav navbar-nav">
						<li><a href="#how">Lorem, ipsum dolor.</a></li>
						<li><a href="#features">Lorem</a></li>
	...
	<script type="text/javascript" src="./static/home/js/jquery.easing.1.3.min.js"></script>
</body>
